...
export const landingCopyPatchSchema = z.object({
  ...
  prePurchaseWarningEnabled: z.boolean(),
  prePurchaseWarningTitle: z.string().min(8).max(160),
  prePurchaseWarningBody: z.string().min(40).max(2200),
  prePurchaseWarningConfirmLabel: z.string().min(4).max(90),
  prePurchaseWarningBackLabel: z.string().min(2).max(48),
